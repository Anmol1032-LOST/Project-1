...
This is the readme for LOST, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. LOST) > Ok.
...
- To run the project find LOST.java (which will be in under src/main/java/com/anmol/games) and right click > Run 'LOST'
