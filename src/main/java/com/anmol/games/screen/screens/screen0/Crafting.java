...
public class Crafting extends Screen {
    ...
    @Override
    protected void init() {
        screenController.app.getInputManager().addMapping("Crafting.click", new MouseButtonTrigger(MouseInput.BUTTON_LEFT));
        screenController.app.getInputManager().addListener(this, "Crafting.click");
    ...
    protected void action(String name, boolean isPressed, float tpf) {
        if (!isPressed && name.equals("Crafting.click")) {
