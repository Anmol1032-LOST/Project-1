...
public class Element extends Screen {
    ...
    @Override
    protected void init() {
        screenController.app.getInputManager().addMapping("Element.click", new MouseButtonTrigger(MouseInput.BUTTON_LEFT));
        screenController.app.getInputManager().addListener(this, "Element.click");
    ...
    protected void action(String name, boolean isPressed, float tpf) {
        if (!isPressed && name.equals("Element.click")) {
