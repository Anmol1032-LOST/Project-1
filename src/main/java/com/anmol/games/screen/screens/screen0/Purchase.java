...
public class Purchase extends Screen {
    ...
    @Override
    protected void init() {
        screenController.app.getInputManager().addMapping("Purchase.click", new MouseButtonTrigger(MouseInput.BUTTON_LEFT));
        screenController.app.getInputManager().addListener(this, "Purchase.click");
    ...
    protected void action(String name, boolean isPressed, float tpf) {
        if (!isPressed && name.equals("Purchase.click")) {
